...
import com.example.submission2githubuser.data.remote.respon.FollowersResponse
...
class FollowingFragment (): Fragment(), FollowersAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.i("com.example.submission1githubuser.ui.Fragment.FollowingFragment", "onViewCreated: $EXTRA_NAME")
        APIViewModel.fetchDataFollowing(EXTRA_NAME)
        ...
        APIViewModel.listReviewFollowing.observe(viewLifecycleOwner) { consumerReviews ->
